package com.geekstar.batch.ac.Service;

import java.math.BigDecimal;
import java.util.*;

import com.geekstar.batch.ac.Bean.*;
import com.geekstar.batch.ac.Implement.*;
import com.geekstar.batch.ac.Interface.*;
...
public class CheckLogic {
	...
	//“搭积木”般的主逻辑
	public void check(String date, String file, IBalancTable balanceTable, IDetailFile detailFile, IResultTable resultTable) {
	...
	public static void main(String[] args) {
		...
		cl.check("20160101", file, new MyBalancTable(), new MyDetailFile(), new MyResultTable());
