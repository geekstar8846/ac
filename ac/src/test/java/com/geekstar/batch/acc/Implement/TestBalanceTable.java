package com.geekstar.batch.acc.Implement;
...
import com.geekstar.batch.ac.Implement.MyBalancTable;
import com.geekstar.batch.ac.Interface.IBalancTable;
...
public class TestBalanceTable {
	...
	public void testMyGetBalanceAmount() {
		...
		getBalanceAmountTest( new MyBalancTable() );
	}

	
	private void getBalanceAmountTest(IBalancTable bt) {
